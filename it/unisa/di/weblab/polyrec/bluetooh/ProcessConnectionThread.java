package it.unisa.di.weblab.polyrec.bluetooh;
...
import it.unisa.di.weblab.polyrec.gdt.TemplateScreen;
...
public class ProcessConnectionThread implements Runnable {
	...
	public void run() {
		...
		/*
		 * ProcessConnectionThread connectionThread = new
		 * ProcessConnectionThread(connection,gui); Thread processThread
		 * = new Thread(connectionThread); processThread.start();
		 */ catch (IOException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
