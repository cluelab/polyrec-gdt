...
public class ComponentResizer extends MouseAdapter {
    ...
    /**
     * Convenience contructor. All borders are resizable in increments of a single pixel. Components can be registered
     * when the class is created or they can be registered separately afterwards.
     *
     * @param components
    ...
    /**
     * Convenience contructor. Eligible borders are resisable in increments of a single pixel. Components can be
     * registered when the class is created or they can be registered separately afterwards.
     *
     * @param dragInsets
     ...
     *            Insets specifying which borders are eligible to be resized.
     * @param snapSize
     *            Specify the dimension to which the border will snap to when being dragged. Snapping occurs at the
     *            halfway mark.
     * @param components
     *            components to be automatically registered
     */
    ...
    /**
     * Set the drag dragInsets. The insets specify an area where mouseDragged events are recognized from the edge of the
     * border inwards. A value of 0 for any size will imply that the border is not resizable. Otherwise the appropriate
     * drag cursor will appear when the mouse is inside the resizable border area.
     *
     * @param dragInsets
    ...
    /**
     * Control how many pixels a border must be dragged before the size of the component is changed. The border will
     * snap to the size once dragging has passed the halfway mark.
     *
     * @param snapSize
    ...
    /**
     * When the components minimum size is less than the drag insets then we can't determine which border should be
    ...
    /**
     * Resize the component ensuring location and size is within the bounds of the parent container and that the size is
     * within the minimum and maximum constraints.
     *
